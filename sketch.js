...
var backgroundImg1,backgroundImg2,backgroundImg2
var score;
...
function preload(){
  //Trex
  trex_running = loadAnimation("Trex/trex1.png","Trex/trex3.png","Trex/trex4.png");
  trex_collided = loadAnimation("Trex/trex_collided.png");
  //Cloud and Ground

groundImage = loadImage("Background/ground2.png");  
  cloudImage = loadImage("Background/cloud.png");
  //Obstacles
...
function setup() {
 ...
 //console.log(message)
  ...
  ground = createSprite(200,580,1000,20);
  ...
  invisibleGround = createSprite(200,590,2500,20);
